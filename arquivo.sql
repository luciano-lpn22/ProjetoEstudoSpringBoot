...
INSERT INTO `categoria` VALUES (1,'Informatica'),(2,'Escritorio'),(3,'Cama Mesa e Banho'),(4,'Eletrônico'),(5,'Jardinagem'),(6,'Decoração'),(7,'Perfumaria'),(8,'Teste');
...
INSERT INTO `endereco` VALUES (1,'Jaardim','38220834','Apto 203','Rua Flores','300',1,1),(2,'centro','38777012','sala 800','Avenida Matos','105',2,1);
...
CREATE TABLE `pagamento_com_cartao` (
  `nummero_de_parcelas` int(11) DEFAULT NULL,
  `pedido_id` int(11) NOT NULL,
  PRIMARY KEY (`pedido_id`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `produto` VALUES (1,'Computador',2000),(2,'Impressora',800),(3,'Mouse',80),(4,'Mesa de Escritorio',300),(5,'Toalha',50),(6,'Colcha',200),(7,'TV true calor',1200),(8,'Roçadeira',800),(9,'Abajour',100),(10,'Pendente',180),(11,'Shampoo',90);
...
INSERT INTO `telefone` VALUES (1,'27363323'),(1,'92838393');
...
-- Dump completed on 2019-07-03 23:01:26
